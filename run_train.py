...
if __name__ == '__main__':
    ...
    for local_job_id, params in product_dict(**args):
        ...
        env_name = ("{id}_"
                    ...
                    "--ms-{max_steps}"
                    "--rnds-{rnd_start}"
                    "--excld-rooms-'{start_state_exclude_rooms}'"
                    "--bsize-{batch_size}").format(**params)
        ...
        params['buff_capacity'] = int(params['buff_capacity'])
        params['eps_decay'] = int(params['eps_decay'])
        ...
        cmd = "python {RUN_FILE} \
                ...
                --seed {seed} \
                --start_state_exclude_rooms {start_state_exclude_rooms} \
                --unseen {unseen} \
                --max_steps {max_steps}".format(**params)
